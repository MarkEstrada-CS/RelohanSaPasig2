        ...
        <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item dropdown">
            <a href="./" class="nav-link nav-home">
              <i class=""></i> <!-- nav-icon fas fa-tachometer-alt -->
              <p>
                Dashboard
              </p>
            </a>
          ...
          <li class="nav-item">
            <a href="#" class="nav-link nav-is-tree nav-edit_category nav-view_category">
              <i class=""></i> <!--nav-icon fa fa-th-list -->
              <p>
                Brands
          ...
          <li class="nav-item dropdown">
            <a href="./index.php?page=orders" class="nav-link nav-orders">
              <i class=""></i> <!-- nav-icon fas fa-list-alt -->
              <p>
                Orders
              </p>
            </a>
          ...
          <li class="nav-item">
            <a href="#" class="nav-link nav-edit_user">
              <i class=""></i> <!-- nav-icon fas fa-users -->
              <p>
                Users
                <i class="right fas fa-angle-left"></i>
              </p>
