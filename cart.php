...
<div class="col-lg-12">	
    ...
    <div class="col-md-4">
    	<div class="card mb-4">
    		<div class="card-header bg-black text-white"><b>Total Amount</b></div>
    		<div class="card-body">
    			<h4 class="text-right"><b id="tamount"><?php echo number_format($total,2) ?></b></h4>
    		</div>
    	</div>
    	<button class="btn btn-block btn-primary bg-black" id="checkout" type="button">Checkout</button>
    </div>
</div>
</div>
<script>
	$('.btn-minus').click(function(){
     ...
     $('#checkout').click(function(){
     	uni_modal('Checkout Order',"manage_order.php");
     })
</script>
