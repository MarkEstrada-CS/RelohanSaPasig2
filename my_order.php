			...
			<table class="table table-hover table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<form action="https://www.facebook.com/czarryanr" method="get" target="_blank">
							<td class="text-center">
		                    	<a href="javascript:void(0)" data-id="<?php echo $row['id'] ?>" data-code="<?php echo $row['ref_id'] ?>" class="btn bg-black btn- btn-flat view_order">
