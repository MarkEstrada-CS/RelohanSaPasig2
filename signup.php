    ...
    <div class="card-body register-card-body">
      ...
      <form id="manage-signup">
	      ...
	      <div class="col-md-12">
	      	<div class="row">
	      		...
	      		<div class="col-md-6">
			        ...
			        <?php if(isset($id)): ?>
						<small><i>Leave if you dont want to change your password.</i></small>
					<?php endif; ?>
			        <div class="input-group mb-3">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" class="btn btn- bg-black btn-block"><?php echo !isset($id) ? 'Register' : 'Update Account'; ?></button>
          </div>
          <!-- /.col -->
        </div>
      </form>
	        ...
	        <?php if(!isset($id)): ?>
      <a href="login.php" class="text-center">If you already have an account, Log-in instead</a>
			<?php endif; ?>
    </div>
    <!-- /.form-box -->
  </div><!-- /.card -->
